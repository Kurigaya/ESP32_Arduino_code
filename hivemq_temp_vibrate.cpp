...
const char* password = "bright45";

/******* MQTT Broker Connection Details *******/
const char* mqtt_server = "1d53307376844525a0d5f47716515a9a.s2.eu.hivemq.cloud";
const char* mqtt_username = "peerapat";
const char* mqtt_password = "Peerapat1/";
...
int getVibration(){
  return analogRead(vibration_pin) - 250;
}
...
void loop() {
  ...
  // Create json document with data from sensors
  DynamicJsonDocument doc(1024);
  doc["deviceId"] = "NodeMCU-ESP8266-02";
  doc["siteId"] = "My Demo Lab";
  doc["vibration"] = getVibration();
